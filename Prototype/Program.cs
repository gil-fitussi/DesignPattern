...
namespace Prototype
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ProfileSettingsPrototypeRegistry profileSettingsPrototypeRegistry = new ProfileSettingsPrototypeRegistry();
            ...
            switch (Console.ReadLine())
            {
                case "1":
                    ...
                    newProfile.SetSettings(profileSettingsPrototypeRegistry.CreateDefaultProfileSettings());
                    break;
                case "2":
                    // Get secure settings prototype.
                    newProfile.SetSettings(profileSettingsPrototypeRegistry.CreateSecureProfileSettings());
                    break;
                default:
                    Console.Write("Private Profile (1 = yes): ");
